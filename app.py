...
def carrinho():
    ...
    if itens: pagina+=f'<div class="cart-total"><div><span>Total</span><br><strong>R$ {total:,.2f}</strong></div><div>{amazon}<a class="cart-btn secondary" href="/produtos">+ Continuar comprando</a><a class="cart-btn danger" href="/carrinho/limpar">Limpar carrinho</a></div></div>'
